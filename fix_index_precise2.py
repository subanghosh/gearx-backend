...
with open('C:/Users/Suban/OneDrive/Documents/vroomly-backend/update_kyc_checks.js', 'r', encoding='utf-8') as f:
    lines = f.readlines()

# Fix syntax error on line 548 (0-indexed 547)
if '});' in lines[547]:
    lines[547] = ''

# Fix kycStatus quotes on line 1149 (0-indexed 1148)
